// Settings "live coat preview". Geometry + palettes come from the shared
// cat-sprite.js (loaded first in settings.html); only the static preview draw
// lives here. Exposes window.PixelcatPreview = { PATTERNS, PATTERN_BUILD, TABBY,
